...
const filters: Filters<ITodo> = {
    ...
    asc: todos =>
        todos.sort(
            (aTodo, bTodo) =>
                calculateDuration(aTodo.startTime, aTodo.endTime) - calculateDuration(bTodo.startTime, bTodo.endTime)
        ),
    desc: todos =>
        todos.sort(
            (aTodo, bTodo) =>
                calculateDuration(bTodo.startTime, bTodo.endTime) - calculateDuration(aTodo.startTime, aTodo.endTime)
        ),
};
